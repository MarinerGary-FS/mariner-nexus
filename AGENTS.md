...
Operate in full ecosystem transformation mode.

Do not update a website. Evolve Mariner Nexus into a synchronized cinematic operational intelligence environment: alive, cinematic, synchronized, operationally intelligent, emotionally aware, future-state ready, stabilizing, sacred, and intentionally restrained.

The ecosystem must never feel trend-chasing, overdesigned, generic SaaS, corporate, emotionally sterile, AI-hype driven, visually noisy, startup performative, or ego-driven.

The implementation target is not: "This is a cool website."

The implementation target is: "Our business has another operational level, and Mariner Nexus understands how to guide that evolution."

## Source Of Truth
The documentation bundle at `/Users/garymariner/Desktop/Mariner Nexus Docs` is the governing source of truth for this project. Treat those files as doctrine, not inspiration. If implementation conflicts with doctrine, doctrine wins.

Read and obey the doctrine in this order before making implementation decisions:
1. `CORE DOCTRINE.md`
2. `EXPERIENCE ARCHITECTURE SYSTEM.md`
3. `ECOSYSTEM SYNCHRONIZATION SYSTEM.md`
4. `MOTION DOCTRINE SYSTEM.md`
5. `VISUAL PHILOSOPHY SYSTEM.md`
6. `TRANSFORMATION STORYTELLING SYSTEM.md`
7. `CTA & CONVERSION ARCHITECTURE.md`
8. `HOMEPAGE EXPERIENCE ARCHITECTURE.md`
9. `INTERACTION & INTERFACE SYSTEM.md`
10. `SPATIAL & LAYOUT SYSTEM.md`
11. `CASE STUDY EVOLUTION ARCHITECTURE.md`
12. `NAVIGATION & ECOSYSTEM FLOW.md`
13. `COMPONENT INTELLIGENCE SYSTEM.md`
14. `ATMOSPHERIC SOUNDLESS DIRECTION.md`
15. `OPERATIONAL COPYWRITING SYSTEM.md`
16. `HOMEPAGE SCENE ARCHITECTURE.md`
17. `DESIGN TOKEN SYSTEM.md`
18. `ENVIRONMENTAL SYSTEMS ARCHITECTURE.md`
19. `MOTION CHOREOGRAPHY SYSTEM.md`
20. `MOBILE IMMERSION ARCHITECTURE.md`
21. `ECOSYSTEM PAGE BLUEPRINTS.md`
22. `STRATEGIC VISUAL LANGUAGE SYSTEM.md`
23. `PERFORMANCE & RESPONSIVENESS PROTOCOL.md`

## Protected Systems
Preserve the sacred systems: logo reveal, background logo video, atmospheric pacing, emotional pauses, synchronized motion, sacred stillness, cinematic restraint, transformation storytelling, future-state immersion, and evolution-entry CTA moments.

These must never become rushed, crowded, overanimated, visually noisy, or generic.

## Homepage Scene Architecture
The homepage must follow this cinematic scene architecture exactly:
1. The Threshold
2. The Fracture
3. The Nexus Reveal
4. The Evolution Layers
5. The Proof Of Transformation
6. The Trust Stabilizer
7. The Evolution Entry

These are emotional operational scenes, not generic sections. Transitions must feel cinematic, synchronized, immersive, emotionally paced, and atmospherically continuous.

## Execution Rules
- Build transformational progression, not page browsing.
- Use environmental depth, restrained lighting, layered atmosphere, intelligent spacing, cinematic composition, and sacred breathing room.
- Motion must be consciously alive: restrained, synchronized, emotionally timed, operationally intelligent, GPU-safe, and cinematic.
- Copy must be declarative, strategic, emotionally intelligent, future-state oriented, and operationally mature.
- CTAs must feel invitational into evolution, not sales pressure. Avoid "Book a Call", "Get Started", and "Contact Us" as primary CTA language. Prefer directions like "Begin Your Evolution Briefing", "Enter the Nexus", "Map Your Future-State Ecosystem", or "Initiate Operational Evolution".
- Case studies are transformation records, not portfolio pieces. Use the progression: Fragmented State, Awakening, Synchronization, Evolution, Continuation.
- Mobile is not a reduced experience. It is the Nexus in the hand, preserving atmosphere, pacing, sacred spacing, emotional rhythm, and cinematic immersion.
- Performance is operational trust. Target Lighthouse scores: Performance 90+, Accessibility 95+, Best Practices 95+, SEO 90+.
- Interactions must feel intelligent, calm, responsive, synchronized, and emotionally aware.
- Components are operational intelligence modules, not generic UI blocks.
- Navigation should feel like progressive ecosystem immersion, not page switching.

## Final Validation
Before implementing any feature, verify:
1. Does this reinforce the doctrine?
2. Does this deepen atmospheric immersion?
3. Does this preserve synchronization?
4. Does this maintain sacred restraint?
5. Does this feel intelligently human?
6. Does this support future-state aspiration?
7. Does this avoid trend-driven behavior?
8. Does this preserve cinematic calmness?
9. Does this strengthen operational trust?
10. Does this feel like the Nexus?

If the answer is no, reject the implementation. Do not build a premium website. Build the Nexus.
