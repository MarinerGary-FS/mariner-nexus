...
export default function StartPage() {
  return <div className="mn-start-page mn-environment-light">
    ...
    <section className="mn-inquiry-section"><Container><Grid><aside><p className="mn-kicker">A thoughtful beginning</p><p>Bring us the objective. We’ll help determine what needs to exist around it.</p><p>No service selection. No budget gate. No marketing enrollment.</p><a href="mailto:info@marinernexus.com">Prefer email? info@marinernexus.com</a></aside><InquiryExperience /></Grid></Container></section>
  </div>;
}
